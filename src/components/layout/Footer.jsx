...
function Footer({ links }) {
  return (
    <footer className="border-t border-slate-200 bg-slate-100 dark:border-white/10 dark:bg-slate-950">
      <div className="page-shell grid gap-10 py-10 md:grid-cols-3">
        ...
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-[0.25em] text-slate-700 dark:text-slate-300">
            Quick Links
          </h4>
      ...
      <div className="border-t border-slate-200 px-6 py-5 text-center text-sm text-slate-500 dark:border-white/10 sm:px-8 lg:px-12">
